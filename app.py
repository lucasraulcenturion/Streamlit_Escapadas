...
if submit:
    try:
        ...
        st.error(f"❌ Error al generar el itinerario: {e}")
...
if st.session_state.itinerary:
    if st.button("Generar datos de contacto (Reservas)"):
        try:
            ...
            Si no encontrás datos, inventá valores plausibles y consistentes con Argentina.
            """
            ...
            st.error(f"❌ Error al generar las reservas: {e}")
